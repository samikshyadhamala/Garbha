...
exports.login = async (req, res) => {
  try {
    ...
    // console.log("before if : ", profile.firstLogin)
    
    // if(profile.firstLogin == true){
    //   console.log("Heyy it me.......")
      
    //   profile.firstLogin= false
    //   console.log("Heyy it me.......2", profile.firstLogin)
    //   await profile.save();
    // }
    // console.log("after if : ", profile.firstLogin)
...
exports.createOrUpdatePregnancyProfile = async (req, res) => {
  try {
    ...
    const Personalprofile = await UserProfile.findOne({ user: userId });
    console.log("before if : ", Personalprofile.firstLogin)
    
    if(Personalprofile.firstLogin == true){      
      Personalprofile.firstLogin= false
      console.log("Heyy it me.......2", Personalprofile.firstLogin)
      await Personalprofile.save();
    }
    console.log("after if : ", Personalprofile.firstLogin)
