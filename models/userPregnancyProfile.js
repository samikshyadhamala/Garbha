...
const userPregnancyProfileSchema = new mongoose.Schema({
  ...
  age: { type: Number, required: true, min: 0 }, // abhinav changes
  pregnantDays: { type: Number, min: 20, max: 300, default: null }, // abhinav changes
  weightBeforePregnancy: { type: Number, min: 20, max: 300, default: null },
  lmp: { type: Date, default: null },
  dueDate: { type: Date, default: null }, // due date
  ...
  lifestyle: {
    ...
    familyHistoryPregnancyComplications: { type: Boolean, default: false }, // abhinav questions (Does family history affects)
  },

  // Optional info
  // preferredName: { type: String, trim: true, default: "none" }, // abhinav changes
  // height: { type: Number, min: 30, max: 250, default: null }, // abhinav changes
}, { timestamps: true });
